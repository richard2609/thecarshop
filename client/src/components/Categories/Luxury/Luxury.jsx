...
const Luxury = ({updateCart, cart, setCart}) => {

    const [products, setproducts] = useState([]);
    useEffect(() => {
        try {
            async function httpgetProductsData() {
                const reponse = await fetch("https://thecarshop.onrender.com/categories/luxury");
    ...
    const luxuryProducts = products.filter(product => product.category === 'luxury');
    console.log(luxuryProducts);
    return (
        <div>
            ...
            <div className='container'>
                ...
                <div className="row">
                    {
                        luxuryProducts.slice(4, 8).map((product, index) => {
                            return (
                                <div key={product.id} className='col-lg-3 col-5'>
                                    <img src={product.imgUrl} className='clip-image img-fluid'></img>
                                    <div className='card'>
